...
const SubjectsList = () => {
  // Assume you fetch subjects from somewhere
  ...
  return (
    <div>
      <SearchBox onSearch={handleSearch} onKeyDown={handleKeyDown} searchTerm={searchTerm} />
      {filteredSubjects.length > 0 && (
        <ul className="absolute bg-white shadow-lg rounded-lg">
          {filteredSubjects.map((subject, index) => (
            <li key={subject.sub_id}
                className={`p-2 cursor-pointer ${index === activeIndex ? 'bg-gray-200' : ''}`}
                onClick={() => handleSelectSubject(subject.subject_name)}>
